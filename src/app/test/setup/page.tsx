...
//                           {(course.status === 'in_progress' || course.status === 'submitted' || course.status === 'auto_submitted') && (
//                             <button
//                               disabled
              ...
              <form onSubmit={handleSendOTP} className="p-8 space-y-6">
                ...
                <div className="space-y-4">
                  {isCheckingLiveStatus ? (
                    ...
                    <div className="bg-linear-to-br from-purple-50 to-indigo-50 border-2 border-purple-100 rounded-2xl p-8 text-center">
                      <h3 className="text-2xl font-bold text-purple-900 mb-4">
                        Coming Soon!
                      </h3>
                      <p className="text-purple-700 mb-6">
                ...
                {!isCheckingLiveStatus && (
                  <div className="border-t border-slate-200 pt-6 mt-8">
                    <p className="text-sm text-slate-600 mb-4 text-center">Not registered for the upcoming tests yet?</p>
                    <button
                      type="button"
                      onClick={() => router.push('/test/register')}
                      className="w-full px-10 py-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 rounded-2xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
