    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-100">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-linear-to-r from-indigo-500 to-purple-600 rounded-full mb-8 shadow-lg shadow-indigo-500/30 animate-fade-in">
          ...
          <button
            ...
            className="group relative px-10 py-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-full text-lg font-semibold shadow-2xl shadow-indigo-500/40 hover:shadow-indigo-500/60 transition-all duration-300 hover:scale-105"
          >
            <span className="relative z-10 flex items-center gap-3">
              Register Now
              <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
            <div className="absolute inset-0 bg-linear-to-r from-indigo-700 to-purple-700 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
          </button>
        </div>
      </section>

      {/* Prizes Section - Hero Treatment */}
      <section className="py-20 bg-linear-to-br from-slate-900 via-indigo-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
              Exciting <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-orange-500">Prizes</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {prizes.map((prize, index) => {
              ...
              return (
                ...
                >
                  <div className={`absolute inset-0 bg-linear-to-br ${prize.gradient} opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity duration-500`} />
                  
                  <div className={`w-16 h-16 bg-linear-to-br ${prize.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-2xl transition-shadow`}>
                    <IconComponent className="w-8 h-8 text-white" />
                  </div>
                  
                  <h3 className="text-white text-lg font-semibold mb-2 text-center">{prize.rank}</h3>
                  <div className={`text-4xl font-bold text-transparent bg-clip-text bg-linear-to-br ${prize.gradient} text-center mb-2`}>
                    {prize.discount}
                  </div>
          ...
          <div className="bg-linear-to-r from-indigo-500/10 to-purple-500/10 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
      ...
      {/* Referral Program */}
      <section className="py-20 bg-linear-to-br from-purple-50 via-white to-blue-50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-purple-500 to-pink-500 rounded-full mb-6 shadow-lg">
              <Gift className="w-4 h-4 text-white" />
              <span className="text-sm text-white font-medium">Referral Rewards</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
              Invite & <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-pink-600">Earn</span>
            </h2>
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                {[
                  ...
                  <div key={idx} className="text-center">
                    <div className="w-16 h-16 bg-linear-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-bold shadow-lg">
                      {item.step}
                    </div>
              ...
              <div className="bg-linear-to-br from-amber-50 to-orange-50 border-l-4 border-amber-500 rounded-lg p-6">
                <div className="flex items-start gap-4">
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">
              Test <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600">Guidelines</span>
            </h2>
          ...
          <div className="space-y-4 mb-10">
            {instructionsArray.map((instruction, index) => (
              <div 
                key={index} 
                className="group flex items-start gap-5 p-6 bg-linear-to-br from-slate-50 to-white border border-slate-200 rounded-2xl hover:border-indigo-300 hover:shadow-xl transition-all duration-300"
              >
                <div className="shrink-0 w-12 h-12 bg-linear-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
          ...
          <div className="bg-linear-to-br from-red-50 to-orange-50 border-l-4 border-red-500 rounded-2xl p-8">
            <div className="flex items-start gap-4">
              <AlertCircle className="w-7 h-7 text-red-600 shrink-0 mt-1" />
              <div>
      ...
      <section className="py-20 bg-linear-to-br from-slate-50 to-indigo-50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">
              What to <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600">Expect</span>
            </h2>
          </div>
            ...
            {[
              ...
              return (
                <div key={index} className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-slate-100">
                  <div className={`w-16 h-16 bg-linear-to-br ${item.color} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                    <IconComponent className="w-8 h-8 text-white" />
                  </div>
      ...
      {/* Final CTA */}
      <section className="py-24 bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button
              ...
              className="group relative px-12 py-6 bg-emerald-500 text-white rounded-full text-lg font-bold shadow-2xl hover:shadow-emerald-500/30 transition-all duration-300 hover:scale-105"
            >
              <span className="relative z-10 flex items-center gap-3">
                Take Test
                <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 p-4 lg:hidden z-50 shadow-2xl">
        <div className="flex gap-4">
          <button
            onClick={handleRegisterClick}
            className="flex-1 bg-linear-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-full text-base font-bold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
          >
            Register Now
          ...
          <button
            onClick={() => router.push('/test')}
            className="flex-1 bg-emerald-500 text-white py-4 rounded-full text-base font-bold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
          >
            Take Test
            <ChevronRight className="w-5 h-5" />
          </button>
