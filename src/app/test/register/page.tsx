...
//       <section className="relative pt-24 pb-16 px-6 bg-linear-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
//         {/* Decorative Elements */}
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 p-4 lg:hidden z-50 shadow-2xl">
        <button
          onClick={handleRegisterClick}
          className="w-full bg-linear-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-full text-base font-bold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
        >
          Register Now
