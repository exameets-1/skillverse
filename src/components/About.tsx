...
//           }`}
//         >
//           <h2 className={`text-3xl lg:text-4xl font-light text-gray-900 mb-8 tracking-tight transition-all duration-1000 delay-300 ${
...
//           <div 
//             className={`group bg-white border border-gray-100 p-8 transition-all duration-1000 delay-300 hover:border-gray-200 hover:shadow-sm ${
//               isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
//             }`}
//           >
//             <div className="mb-8 flex items-center gap-4">
...
//           <div 
//             className={`group bg-white border border-gray-100 p-8 transition-all duration-1000 delay-400 hover:border-gray-200 hover:shadow-sm ${
//               isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
//             }`}
//           >
//             <div className="mb-8 flex items-center gap-4">
...
//           <div 
//             className={`group bg-white border border-gray-100 p-8 transition-all duration-1000 delay-500 hover:border-gray-200 hover:shadow-sm ${
//               isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
//             }`}
//           >
//             <div className="mb-8 flex items-center gap-4">
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h2 
            className="text-3xl lg:text-5xl font-light text-gray-900 mb-8 tracking-tight"
            style={{
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {/* Industry-Updated Curriculum */}
          <div 
            className="group bg-white border border-gray-100 p-8 hover:border-gray-200 hover:shadow-sm"
            style={{
              opacity: scrollProgress,
              transform: `translateY(${contentTranslateY}px)`,
