        ...
        {registrationState.success && (
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 mb-8">
                  ...
                  <div className="border-t border-white/20 pt-6 mt-4">
                    <p className="text-green-200 text-sm mb-4 font-medium">Share with friends and earn rewards!</p>
                    <div className="flex gap-3 justify-center">
                      <a
                        href={`https://wa.me/?text=${encodeURIComponent(`🎯 Join Exameets Skillverse Talent Hunt 2025!\n\nCompete with the best and win course discounts up to 75% OFF! 🏆\n\nUse my referral code: ${registrationState.data?.student?.referralCode}\n\nRegister now: https://skillverse.exameets.in/test/register`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-5 py-3 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-xl transition-all duration-300 font-medium shadow-lg hover:shadow-xl hover:scale-105"
                      >
                      ...
                      <a
                        href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://skillverse.exameets.in/test/register')}&quote=${encodeURIComponent(`🎯 Join Exameets Skillverse Talent Hunt 2025! Use my referral code: ${registrationState.data?.student?.referralCode} and win course discounts up to 75% OFF!`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-5 py-3 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-xl transition-all duration-300 font-medium shadow-lg hover:shadow-xl hover:scale-105"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a
                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`🎯 Join Exameets Skillverse Talent Hunt 2025!\n\nUse my referral code: ${registrationState.data?.student?.referralCode}\n\nWin course discounts up to 75% OFF! 🏆`)}&url=${encodeURIComponent('https://skillverse.exameets.in/test/register')}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-5 py-3 bg-[#1DA1F2] hover:bg-[#1A91DA] text-white rounded-xl transition-all duration-300 font-medium shadow-lg hover:shadow-xl hover:scale-105"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
