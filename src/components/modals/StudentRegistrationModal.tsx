...
{registrationState.success && (
  <div className="fixed inset-0 bg-linear-to-br from-green-500/95 via-emerald-600/95 to-teal-600/95 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div className="flex flex-col items-center gap-8 text-center px-4 max-w-2xl">
      {/* Success Icon */}
      <div className="relative">
      ...
      <div>
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 mb-8">
          ...
          <div className="border-t border-white/20 pt-6 mt-4">
            <p className="text-green-100 text-base mb-4 font-medium">
