...
export default function JavaCoreOOPSClient() {
  ...
  const courseData: CourseData = {
    ...
    description: "Master Java programming fundamentals and Object-Oriented Programming concepts. Build strong foundation with Core Java, OOPs principles, Collections, Exception Handling through 5 practical projects.",
    curriculum: [
      "Level 0: Java Basics (12 Days) - Syntax, Variables, Data types, Operators, Control structures, Calculator App",
      "Level 1: Object-Oriented Programming (15 Days) - Classes, Objects, Inheritance, Polymorphism, Student Management System", 
      "Level 2: Advanced OOPs (12 Days) - Abstraction, Encapsulation, Interfaces, Packages, Banking System",
      "Level 3: Collections Framework (12 Days) - ArrayList, HashMap, LinkedList, TreeSet, Library Management System",
      "Level 4: Exception Handling & File I/O (9 Days) - Try-catch, Custom exceptions, File operations, Employee Database System"
    ],
    highlights: [
      "5 hands-on Java projects",
      "Max 12 students for focused learning", 
      "Industry-standard Java coding practices",
      "Strong foundation for advanced Java topics",
      "100% placement assistance",
      "Real-world problem-solving approach"
    ],
    prerequisites: "No programming experience required - perfect for absolute beginners and CS students",
    careerOutcomes: "Java Developer, Software Developer, Backend Developer, Java Programmer",
    salaryRange: "₹4-8 LPA for Java Core developers",
    tools: "Eclipse/IntelliJ IDEA, JDK, Git, MySQL"
  };

  const quickQuestions: string[] = [
    "What will I learn in Java Core?",
    "What projects will I build?", 
    "Is this good for complete beginners?",
    "What's the batch timing?",
    "Do I get placement assistance?",
    "What tools will I use?",
    "Can I learn advanced Java after this?"
  ];
  ...
  const curriculum = [
    {
      ...
      duration: "12 Days",
      icon: Code2,
      topics: ["Java syntax & fundamentals", "Variables & data types", "Operators & control structures", "Calculator Application project"]
    },
    {
      level: "Level 1", 
    ...
    },
    {
      ...
      duration: "12 Days", 
      icon: Layers,
      topics: ["Abstraction & Encapsulation", "Interfaces & Abstract classes", "Packages & Access modifiers", "Banking System project"]
    },
    {
      level: "Level 3",
      ...
      duration: "12 Days",
      icon: Settings,
      topics: ["ArrayList & LinkedList", "HashMap & TreeSet", "Iterator & Generics", "Library Management System"]
    },
    {
      level: "Level 4",
      ...
      duration: "9 Days",
      icon: Award,
      topics: ["Try-catch blocks", "Custom exceptions", "File input/output operations", "Employee Database System"]
    }
  ];

  const highlights = [
    { icon: Award, title: "Practical Projects", desc: "5 real-world Java applications" },
    { icon: Users, title: "Small Batches", desc: "Max 12 students for individual attention" },
    { icon: Code2, title: "Industry Standards", desc: "Professional Java coding practices" },
    { icon: CheckCircle, title: "Strong Foundation", desc: "Perfect base for advanced Java learning" }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Calculator App, Student Management System, Banking System, Library Management System, and Employee Database System - all using core Java concepts."
    },
    {
      q: "Will this prepare me for advanced Java topics?",
      a: "Absolutely! This course builds a rock-solid foundation in Core Java and OOPs, preparing you for Spring, Hibernate, and other advanced frameworks."
    },
    {
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6 tracking-tight">
            Java Core & <span className="font-medium text-black">OOPs</span>
          </h1>
          <p className="text-xl text-gray-600 font-light mb-8 leading-relaxed max-w-2xl mx-auto">
            Master Java programming fundamentals and Object-Oriented Programming concepts
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 mb-10 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-black">₹10,000</span>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl text-black font-light text-center mb-12 tracking-tight">
            Why Choose Our <span className="font-medium">Java Core & OOPs</span> Course
          </h2>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center mb-12 font-light">
            Comprehensive curriculum from Java basics to advanced Object-Oriented Programming
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              "CS students needing strong Java foundation", 
              "Professionals planning to switch to Java development"
            ].map((text, index) => (
      ...
      <section className="py-16 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-light mb-4 tracking-tight">
            Ready to Master <span className="font-medium">Java Core & OOPs</span>?
          </h2>
          <p className="text-gray-300 font-light mb-8">
            Join aspiring developers who have built strong programming foundations with Java
          </p>
